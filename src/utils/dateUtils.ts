...
export function getStartAndEndOfWeek(date: Date): { startOfWeek: Date; endOfWeek: Date } {
...
export const generateUniqueKeyForWeek = (startOfWeek: Date, endOfWeek: Date): string => {
